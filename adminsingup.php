    ...
    <section class="signup">
        ...
        <div class="container">
            ...
            <div class="row mt-5">
                ...
                <h2 class="form-title">Teacher Signup Pages</h2>
                        ...
                        <div class="already">
                            <span>Already Register?<a href="adminsigninpage.php">Login</a></span>
                            <br>
...
if($countemail>0){
    ...
    if($pass===$cpass){
        ...
        if($fileerror==0){
            ...
            $insetquery="insert into teacher(teacherName,email,password,cpassword,token,status,pic) VALUES ('$name','$email','$str_pass','$str_cpass','$token','inactive','$destfile')";
            ...
            if($query){
                ...
                http://localhost/Online%20quiz%20app/adminactivate.php?admintoken=$token ";
