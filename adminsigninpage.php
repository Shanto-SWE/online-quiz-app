                        ...
                        <form method="POST" action="<?php echo htmlentities($_SERVER['PHP_SELF']);?>" class="register-form" id="login-form">
                            ...
                            <div class="form-group form-button">
                                <input type="submit" name="submit" id="signin" class="form-submit" value="Log in"/>
                                                ...
                                                <a href="adminsingup.php" class="signup-image-link">Create account here</a><br>
                        </div>
...
if(isset($_POST['submit'])){
    ...
    $email_serch="select * from teacher where email='$email' and status='active'";
    ...
    if($email_count){
        ...
        $_SESSION['usernameadmin']=$email_pass['teacherName'];
